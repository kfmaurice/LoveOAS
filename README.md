...
3. [IParser](Dynamite.LoveOAS/Interfaces/IParser.cs) converts endpoints to [nodes](Dynamite.LoveOAS/Discovery/Node.cs) ready to be serialized as a matter of links.
