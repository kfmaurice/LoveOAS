...
namespace TestWebApiUnity.Controllers
{
  ...
  public class PeopleController : ApiController
  {
    ...
    [Entry("Auth")]
    [Route("auth")]
    [ExtendedAuthorize] // change "Settings.CheckAuthorization" in UnityConfig.cs and see what happens when you call "api/people/base"
    ...
    [Route("void")]
    [HttpGet]
    public Person NotAffectedByPlugin() // change "Settings.HandleOnlyMarkedApis" in UnityConfig.cs and see what happens
    {
    ...
    {
      // change "Settings.TreatCollectionAsPayload" in UnityConfig.cs and see what happens
